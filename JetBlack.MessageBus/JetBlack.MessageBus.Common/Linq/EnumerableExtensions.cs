...
namespace JetBlack.MessageBus.Common.Linq
{
    ...
    public static class EnumerableExtensions
    {
        ...
        /// <param name="func">The function to use when aggregatng a batch.</param>
        ...
        /// <param name="valueSelector">A selector function to be applided to each item in the source collection.</param>
        ...
        public static IEnumerable<KeyValuePair<TKey, TValue>> Fill<TItem, TKey, TValue>(this IEnumerable<TItem> source, IEnumerable<TKey> keys, Func<TItem, TKey> keySelector, Func<TItem, TValue> valueSelector, Func<TKey,TValue> defaultValue)
        {
            using (var enumerator = source.GetEnumerator())
            {
                ...
                {
                    if (hasValue && key.Equals(keySelector(enumerator.Current)))
                    {
        ...
        /// <summary>
        /// Generates a rolling average enumeration.
        /// </summary>
        /// <param name="source">An enumeration of dates and values</param>
        /// <param name="firstDate">The first valid date.</param>
        /// <param name="lastDate">The last valid date.</param>
        /// <param name="days">The number of days in the window</param>
        /// <returns></returns>
        public static IEnumerable<KeyValuePair<DateTime, double?>> RollingAverage(this IEnumerable<KeyValuePair<DateTime, double>> source, DateTime firstDate, DateTime lastDate, int days)
        {
            return source
        ...
        /// <summary>
        /// Applies an aggreation to a rolling window to provide an enumeration of aggregated responses.
        /// </summary>
        /// <param name="source">The source collection.</param>
        /// <param name="count">The size of the rolling window.</param>
        /// <param name="aggregator">The function to be applied to the content of a window.</param>
        /// <typeparam name="TItem">The type of the items in the source collection.</typeparam>
        /// <typeparam name="TResult">The type of the result of the aggregation function.</typeparam>
        /// <returns>An enumeration of aggregations of the rolling window.</returns>
        public static IEnumerable<TResult> RollingAggregation<TItem, TResult>(this IEnumerable<TItem> source, int count, Func<IList<TItem>, TResult> aggregator)
        {
            return source.RollingWindow(count).Select(x => aggregator(x.ToList()));
        }

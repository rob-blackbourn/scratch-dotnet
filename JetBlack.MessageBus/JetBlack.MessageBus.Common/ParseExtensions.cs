...
namespace JetBlack.MessageBus.Common
{
    ...
    public static class ParseExtensions
    {
        ...
        /// <param name="style">The styles to obey.</param>
        /// <returns>Either a date time or null</returns>
        public static DateTime? AsDateTime(this string text, string format, IFormatProvider provider = null, DateTimeStyles style = DateTimeStyles.None)
        {
            DateTime value;
        ...
        /// <param name="style">The styles to obey.</param>
        /// <returns>Either a date time or null</returns>
        public static DateTime? AsDateTime(this string text, string[] formats, IFormatProvider provider = null, DateTimeStyles style = DateTimeStyles.None)
        {
            DateTime value;
        ...
        {
            return text.AsEnumerable(AsTimeSpan, separators, StringSplitOptions.RemoveEmptyEntries).Where(x => x.HasValue).Select(x => x.Value);
        }
